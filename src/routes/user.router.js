...
router.get("/pending-payment",authentication, userController.pendingPayment);
router.post("/delete-pending-payment",authentication,validate(user.deletePendingPayment),userController.deletePendingPayment);
